...
export const zhCN: Dict = {
  ...
  "plugins.availableDetails.closeDialog": "关闭可用插件详情",
  ...
  "plugins.contextChipsEmpty": "没有活动的插件上下文。",
  "plugins.contextChipsRemove": "移除 {kind} {label}",
  "plugins.import.kicker": "用户插件",
  "plugins.import.title": "导入插件",
  "plugins.import.closeDialog": "关闭导入对话框",
  "plugins.import.sourceTabs": "导入来源",
  "plugins.import.tabGithub": "从 GitHub",
  "plugins.import.tabGithubBody": "安装 github:owner/repo 路径。",
  "plugins.import.tabZip": "上传 zip",
  "plugins.import.tabZipBody": "上传插件压缩包。",
  "plugins.import.tabFolder": "上传文件夹",
  "plugins.import.tabFolderBody": "上传插件目录。",
  "plugins.import.sourceLabel": "GitHub、压缩包或市场来源",
  "plugins.import.sourceHelp": "支持 {sourceSpec}、HTTPS {archiveExts} 压缩包或市场插件名称。",
  "plugins.import.submit": "导入",
  "plugins.import.submitWorking": "导入中…",
  "plugins.import.zipBody": "选择包含 open-design.json、SKILL.md 或 .claude-plugin/plugin.json 的 .zip 压缩包。",
  "plugins.import.folderBody": "选择插件文件夹。相对路径将被保留并安装到你的用户插件注册表中。",
  "plugins.import.noZipSelected": "未选择 zip",
  "plugins.import.noFolderSelected": "未选择文件夹",
  "plugins.import.filesSelected": "已选择文件：{count}",
  "plugins.import.footerNote": "导入的插件为用户插件，与捆绑的官方插件分开存储。",
  ...
  "brand.fontsMissingTitle": "缺少品牌字体文件",
  "brand.fontsMissingBody": "在添加品牌字体文件之前，排版预览将使用替代网页字体。",
  "brand.fontsAddFiles": "添加品牌字体文件",
  "brand.fontsKeepSubstitutes": "保留替代字体",
